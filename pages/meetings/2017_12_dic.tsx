  ...
  return (
    <PageLayout home>
      <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
        ...
        Incontro del 12 Dicembre 2017 presso la Biblioteca di Pordenone.
        </Text>
...
export async function getStaticProps() {
  const dir_slider_img='./public/imp_assets/meetings/venezia_slider'
  ...
  const filenames = fs.readdirSync(absolute_path_dir, { withFileTypes: true })
    ...
    .map(file => '/public/imp_assets/meetings/venezia_slider/' + file.name)
  return {
    props: {
      filenames,
    },
