    ...
    <PageLayout home>
      <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
        ...
        <Text className="mt-10">
          ...
          Incontro del 15 Dicembre 2016 presso la Biblioteca di Pordenone.
...
export async function getStaticProps() {
  const dir_slider_img = './public/imp_assets/meetings/le_vie_della_seta_slider'
  ...
  const filenames = fs.readdirSync(absolute_path_dir, { withFileTypes: true })
    ...
    .map(file => '/public/imp_assets/meetings/le_vie_della_seta_slider/' + file.name)
  return {
    props: {
      filenames,
    },
