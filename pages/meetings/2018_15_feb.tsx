    ...
    <PageLayout home>
      <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
        ...
        <Text className="mt-10">
          Incontro del 15 Febbraio 2018 presso la Biblioteca di Pordenone.
        </Text>
...
export async function getStaticProps() {
  const dir_slider_img='./public/imp_assets/meetings/ferrara_slider'
  ...
  const filenames = fs.readdirSync(absolute_path_dir, { withFileTypes: true })
    ...
    .map(file => '/public/imp_assets/meetings/ferrara_slider/' + file.name)
  return {
    props: {
      filenames,
    },
